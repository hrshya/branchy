                            ...
                            {!isCollapsed && (
                                ...
                                >
                                    <div className="w-8 h-8 rounded-xl bg-amber-500/10 flex items-center justify-center p-0.5 shrink-0 shadow-inner border border-amber-500/20">
                                        <img src="/logo.png" alt="branchy Logo" className="w-full h-full object-contain drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
                                    </div>
                                    <span className="font-semibold text-lg tracking-tight whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">branchy</span>
                                </motion.div>
                            )}
                        </AnimatePresence>
                        <Button
